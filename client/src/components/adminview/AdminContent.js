        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Grid className={classes.background} item xs={6} md={4} lg={3}>
            ...
            <Grid className={classes.background} item xs={12} md={5} lg={12}>
              ...
              <LineGraph dateGroups={props.dateGroups} getDataSet={getDataSet} title={"Number of New Users by Month - " + new Date().getFullYear()} tooltipLabel="MMMM yyyy" yaxisLabel="# of Students" dataSetLabel="# of Students" lineColor="#4b2e83" />
              {/* </Paper> */}
            </Grid>
