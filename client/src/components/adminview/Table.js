...
const headCells = [
  ...
  { id: 'classStanding', numeric: false, disablePadding: false, label: 'Class Standing' },
  { id: 'military', numeric: false, disablePadding: false, label: 'Military Affiliation' },
];
...
export default function EnhancedTable(props) {
  ...
  const userList = props.userList || rows;
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.classStanding}</TableCell>
